...
public class RedHenCounterfactualityTest extends CounterfactualityCycle {
	...
	public RedHenCounterfactualityTest() {
		super("agent", new String[] {"hen", "cow", "dog", "pig"});
	...
	public static void main(String[] args) {
		RedHenCounterfactualityTest cycle = new RedHenCounterfactualityTest();
		cycle.run();
