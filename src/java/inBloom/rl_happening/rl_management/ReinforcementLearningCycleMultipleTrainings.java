 ...
 *
 */
public abstract class ReinforcementLearningCycleMultipleTrainings extends PlotCycle {

	private static final int numberOfEpisodes = 5;
	...
	public ResultWriterMultipleTrainings resultWriter;
	...
	public ReinforcementLearningCycleMultipleTrainings(String agentSource, String[] agentNames, Personality[] agentPersonalities, String fileName) {
...
//		this.originalMood = originalMood; // TODO why needed?
		...
		this.resultWriter = new ResultWriterMultipleTrainings(fileName);
