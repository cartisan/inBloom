 ...
 *
 */
public class RobinsonCycleMultipleTrainings extends ReinforcementLearningCycleMultipleTrainings {
	 ...
	 */
	public RobinsonCycleMultipleTrainings(String fileName) {
		super("islandAgent", agentNames, agentPersonalities, fileName);
	}
	
	public static void main(String[] args) {
		String fileName = args[0];
		
		RobinsonCycleMultipleTrainings cycle = new RobinsonCycleMultipleTrainings(fileName);
		cycle.run();
	}
